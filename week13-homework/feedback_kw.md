...
**fantastic plots and code!**<br /> Do you need the 2nd allele list? Since there are only two alleles, you should be able to use the first list to get the second allele values if needed. This will save time algorithmically and memory, because you don't have to compute and store the A2 freq/count. But I do really like how your function also returns the generation number.
